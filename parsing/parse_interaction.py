...
def guard_noun() -> Parser:
    ...
    corrections = ['god', 'good', 'aids', 'jobs', 'dogs', 'car', 'ga', 'girl']
...
def auto_take_out_guard() -> Parser:
    ...
    """
    kill_words = ['kill', 'destroy', 'waste', 'fight']
    ...
    verb_parser = strongest([attack, kill, knock_out, take_out, tear_apart])
